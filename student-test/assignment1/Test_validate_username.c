...
void test_validate_my_username()
{
    ...
    const char * my_username_str = my_username();
    char * username_from_conf = malloc_username_from_conf_file();

    TEST_ASSERT_EQUAL_STRING_MESSAGE(my_username_str, username_from_conf, "Username from my_username() does not match username from conf/username.txt");
